...
const translations = {
  en: {
    ...
    'gamification.todayXp': "Today's XP",
    'gamification.continueWhereLeft': 'Continue where you left off',
    'gamification.quickActions': 'Quick Actions',
    'gamification.resumePractice': 'Resume Practice',
    'gamification.dailyChallenge': 'Daily Challenge',
    'gamification.browseCourses': 'Browse Courses',
    'gamification.labs': 'Labs',
    'gamification.mastery': 'Mastery',
    'gamification.weakAreas': 'Weak Areas',
    'gamification.achievements': 'Achievements',
    'gamification.featuredBadges': 'Featured Badges',
    'gamification.challenges': 'Challenges',
    'gamification.friends': 'Friends',
    'gamification.notifications': 'Notifications',
    'gamification.recommendations': 'Recommended Next',
    'gamification.studyHeatmap': 'Study Heatmap',
    'gamification.leaderboard': 'Leaderboard',
    'gamification.leaderboardWeekly': 'Weekly',
    'gamification.leaderboardAllTime': 'All-Time',
    'gamification.leaderboardSeason': 'Season',
    'gamification.leaderboardGlobal': 'Global',
    'gamification.leaderboardCourse': 'Per Course',
    'gamification.yourRank': 'Your Rank',
    'gamification.xpToNext': 'XP to next rank',
    'gamification.liveActivity': 'Live Activity',
    'gamification.season': 'Season',
    'gamification.levelUp': 'Level Up!',
    'gamification.daysLeft': 'days left',
    'gamification.privacy': 'Privacy',
    'gamification.showOnLeaderboard': 'Appear on leaderboards',
    'gamification.showInLiveFeed': 'Show activity in live feed',
    'gamification.allowFriendRequests': 'Allow friend requests',

    // Admin Gamification
    'admin.gamification': 'Gamification',
    'admin.gamification.leaderboard': 'Leaderboard Control',
    'admin.gamification.scoring': 'Scoring Weights',
    'admin.gamification.antiCheat': 'Anti-Cheat',
    'admin.gamification.seasons': 'Seasons',
    'admin.gamification.bans': 'Bans',
    'admin.gamification.forceReset': 'Force Weekly Reset',
  },
} as const;
